...
function test {
    ...
    export DISPLAY=:0
    ./me.Appadeia.systeminformation --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja me.Appadeia.systeminformation-pot
    ninja me.Appadeia.systeminformation-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./me.Appadeia.systeminformation "${@:2}"
    ;;
"test")
    test
    ;;
